...
//         const nav_items = document.getElementsByClassName('story-link');
//         Array.from(nav_items).forEach(i => i.classList.remove('display-none'));
//     } else {
//         nav.style.backgroundColor = 'transparent';
//         slug.style.display = 'none';
//         const nav_items = document.getElementsByClassName('story-link');
//         Array.from(nav_items).forEach(i => i.classList.add('display-none'));
//     }
// }
...
function toggleDropdown() {
    const nav_items = document.getElementsByClassName('item');
    Array.from(nav_items).forEach(i => i.classList.toggle('show'))
}
