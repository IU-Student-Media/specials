const data = {
    "url": "mascot-ranking-big-ten",
    "slug": "Mascot Ranking",
    "headline": "COLUMN: The objectively correct ranking of every mascot in the Big Ten",
    "title": "Mascot Ranking",
    "pub_date": "Dec. 9, 2025",
    "bylines": {
        "By": {
            "name": "Quinn Richards",
            "email": "catchar@iu.edu",
            "pfp": "https://s3.amazonaws.com/snwceomedia/ids/476b7b51-55d1-46d7-95fa-72208d64095c.original.jpg",
            "twitter": "Quinn_richa",
            "bio": "Quinn Richards has worked on the IDS sports desk since 2023."
        },
...
document.querySelector('li#socials').innerHTML = socialsHTML;
// document.querySelector('.share2 .socials').innerHTML = socialsHTML;
