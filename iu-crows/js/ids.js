...
function checkScroll() { // callback function 
    ...
    if(window.scrollY > startY) { 
        ...
        nestFooter.style.opacity = "1";
        nestFooter.style.pointerEvents = "all";
    } else {
        nav.style.backgroundColor = 'transparent';
        slug.style.display = 'none';

        nestFooter.style.opacity = "0";
        nestFooter.style.pointerEvents = "none";
    }
}
...
document.getElementById("nest-button").style.visibility = "visible";
document.getElementById("nest-button-footer").style.visibility = "visible";
...
setTimeout(() => {
        document.getElementById("nest-crow").style.visibility = "visible";
        document.getElementById("nest-crow-footer").style.visibility = "visible";
    }, 50);
}
