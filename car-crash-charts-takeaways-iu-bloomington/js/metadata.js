const data = {
    "url": "car-crash-charts-takeaways-iu-bloomington",
...
// bylines
const byline_types = ["Story, graphics, data, design and development by",]
let bylines_html = '';
let bios_html = '';
...
function setAuthorBio(type, author) {
    ...
    let email_link = `<br><span style="padding-right: var(--xs); padding-left: var(--xxs);"><a
