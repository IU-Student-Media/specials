...
let adDivs=document.querySelectorAll(".ad"),adCount=2;for(let t of adDivs){let e=++adCount%5==0?4:adCount%5-1;t.outerHTML=`
                ...
                <!-- END AD BLOCK -->`}let scrollBuffer=0;function setStickyContainersSize(){document.querySelectorAll(".gallery-sticky").forEach(function(e){var t=e.querySelector(".gallery > div:first-of-type").scrollWidth,i=e.querySelector(".gallery > div:first-of-type").offsetHeight;t<i?(t=i+e.querySelector(".gallery").scrollWidth,e.setAttribute("style","height: "+t+"px")):(i=e.querySelector(".gallery").scrollWidth+e.querySelector(".sticky-inner").offsetHeight-e.querySelector(".sticky-inner").scrollWidth+2*scrollBuffer,e.setAttribute("style","height: "+i+"px"))})}function isElementInViewport(e){e=e.getBoundingClientRect();return e.top<=0&&e.bottom>=document.documentElement.clientHeight}function bindEvents(){trackScroll()}function trackScroll(){var e,t,i=Array.from(document.querySelectorAll(".gallery-sticky")).filter(function(e){var t,i=isElementInViewport(e);return i||(t=e.offsetHeight,e.offsetTop<window.pageYOffset?e.querySelector(".gallery").scrollLeft=t:(e.offsetTop,window.pageYOffset,e.querySelector(".gallery").scrollLeft=0)),i})[0];i&&(t=i.offsetTop<document.documentElement.scrollTop,e=i.offsetTop+i.offsetHeight>document.documentElement.scrollTop,t)&&e&&(t=window.pageYOffset-i.offsetTop,i.querySelector(".gallery").scrollLeft=t),requestAnimationFrame(trackScroll)}function initGallery(){setStickyContainersSize(),bindEvents()}document.addEventListener("scroll",bindEvents),window.addEventListener("resize",setStickyContainersSize),initGallery(),document.querySelectorAll(".glass-interactive").forEach(e=>{const i=e.children.namedItem("glassCursor");e.addEventListener("mouseenter",()=>{document.onmousemove=e=>{var t=e.clientY,e=e.clientX;i.style.top=t+"px",i.style.left=e+"px"},i.style.opacity=1}),e.addEventListener("mouseleave",()=>{document.onmousemove=null,i.style.opacity=0})}),function(e,t,i,s){e[s]=e[s]||[],e[s].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});e=t.getElementsByTagName(i)[0],s=t.createElement(i);s.async=!0,s.src="//www.googletagmanager.com/gtm.js?id=GTM-NBJX8F",e.parentNode.insertBefore(s,e)}(window,document,"script","dataLayer");const nav=document.querySelector("nav"),slug=document.querySelector(".logo span"),header=document.querySelector("header");function checkScroll(){var e=.6*header.offsetHeight;window.scrollY>e?(nav.style.backgroundColor="black",slug.style.display="block"):(nav.style.backgroundColor="transparent",slug.style.display="none")}function toggleDropdown(){document.querySelector(".item").classList.toggle("show")}window.addEventListener("scroll",checkScroll),document.querySelector(".toggle").addEventListener("click",toggleDropdown),$.fn.moveIt=function(){var e=$(window),i=[];$(this).each(function(){i.push(new moveItItem($(this)))}),window.addEventListener("scroll",function(){var t=e.scrollTop();i.forEach(function(e){e.update(t)})},{passive:!0})};var moveItItem=function(e){this.el=$(e),this.speed=parseInt(this.el.attr("data-scroll-speed"))};moveItItem.prototype.update=function(e){this.el.css("transform","translateY("+-(e/this.speed)+"px)")},$(function(){$("[data-scroll-speed]").moveIt()});let currentTimeInterval,cardWidthTimeout;const tag=document.createElement("script"),firstScriptTag=(tag.src="https://www.youtube.com/iframe_api",document.getElementsByTagName("script")[0]);firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);let player;function onYouTubeIframeAPIReady(){document.querySelectorAll(".player").forEach(e=>{var e=e.id,t=document.querySelector("#"+e).getAttribute("data-youtube-video-id");new YT.Player(e,{videoId:t,playerVars:{height:"unset",width:"unset",playsinline:1,modestbranding:1},events:{onStateChange:onPlayerStateChange}})})}function onPlayerStateChange(e){e.data==YT.PlayerState.PLAYING?currentTimeInterval=setInterval(()=>{handleVideoTime(e.target.getCurrentTime(),e)},1e3):clearInterval(currentTimeInterval)}function handleVideoTime(t,e){const i=e.target.o.getAttribute("data-youtube-video-id");var s={speakers:[{id:"maya",name:"Maya Goldenberg",picture:"http://127.0.0.1:5500/build/wap-antisemitism/assets/dev/select7.jpg",cardWidth:"256px"}],videos:[{id:"ScMzIvxBSi4",timestamps:[{time:0,speaker:"maya"}]}]},l=s.videos.find(e=>e.id===i);let o;l.timestamps.forEach(e=>{t>e.time&&(o=e.speaker)}),o=s.speakers.find(e=>e.id===o);const a=e.target.h.parentNode.parentNode.querySelector(".speakingCard");a.querySelector(".name").innerHTML!==o.name&&(992<=window.innerWidth&&(a.style.width=o.cardWidth),a.querySelector(".name").innerHTML=o.name,a.querySelector("img").alt=o.name,a.querySelector("img").src=o.picture,clearTimeout(cardWidthTimeout),cardWidthTimeout=setTimeout(()=>{a.style.width=a.offsetHeight+"px"},5e3))}document.querySelectorAll(".speakingCard").forEach(e=>{e.style.width=e.offsetHeight+"px"}),document.querySelectorAll(".content-warning").forEach(e=>{e.querySelector("button").addEventListener("click",()=>{e.classList.add("hide"),e.addEventListener("animationend",()=>{e.style.display="none"}),document.querySelector("#hideBtn").addEventListener("click",()=>{e.classList.remove("hide"),e.style.display="flex"})})});const data={url:"antisemitism-iu-mezuzah-the-avenue",slug:"Faith over fear",headline:"‘We will always outlive the people who hate us’",title:"‘We will always outlive the people who hate us’",pub_date:"Dec. 16, 2022",bylines:{"Written by":{name:"Christina Avery",email:"averycm@iu.edu",twitter:"christym_avery",pfp:"https://s3.amazonaws.com/snwceomedia/ids/278a97fa-20ae-46fb-a147-3e84166568c4.sized-1000x1000.jpg",bio:"Christina has worked at the IDS since 2020 as a news and enterprise reporter."},"Photos and videos by":{name:"Anya Heminger",email:"aiheming@iu.edu",pfp:"https://s3.amazonaws.com/snwceomedia/ids/a80ffef2-0882-41dd-a585-a464912ddc5a.sized-1000x1000.jpg",bio:"Anya Heminger is a photojournalism student and they are graduating in the fall of 2023."},"Design and development by":{name:"Jacob Day",email:"jacobmday@alumni.iu.edu",twitter:"_jacobmday",pfp:"https://s.gravatar.com/avatar/1e2241c3b494e488c02e98ec554508ac?s=400",bio:"Jacob has worked at the IDS since 2022 as a web designer."}}},byline_types=["Written by","Photos and videos by","Design and development by","Graphics by"];let bylines_html="",bios_html="";for(let t of byline_types)data.bylines[t]&&(data.bylines[t].length?data.bylines[t].forEach(e=>setAuthorBio(t,e)):setAuthorBio(t,data.bylines[t]));for(let t of byline_types)if(data.bylines[t])if(data.bylines[t].length){bylines_html+="<p>"+t;for(let e in data.bylines[t])bylines_html+=` <a target="_blank" href="https://idsnews.com/staff/${data.bylines[t][e].name.split(" ").join("-")}">${data.bylines[t][e].name}</a>`,e!=data.bylines[t].length-2&&e!=data.bylines[t].length-1?bylines_html+=",":e==data.bylines[t].length-2&&(bylines_html+=" and");bylines_html+="</p>"}else bylines_html+=`<p>${t} <a target="_blank" href="https://idsnews.com/staff/${data.bylines[t].name.split(" ").join("-")}">${data.bylines[t].name}</a></p>`;function setAuthorBio(e,t){var i=`<span><a href="https://twitter.com/${t.twitter}" target="_blank">Twitter <i class="fab fa-twitter"></i></a></span>`,s=`<span style="padding-right: var(--xs); padding-left: var(--xxs);"><a
        href="mailto:${t.email}" target="_blank">Email <i class="fa fa-envelope"></i></a></span>`;t.pfp&&t.bio&&(bios_html+=`<div class="bio">
                        <div>
                            ...
                            <p>${t.bio}  ${t.email?s:""}   ${t.twitter?i:""}</p>
                            </div>
                        </div>
...
</svg>`,audioQuote=`<svg id="audio-quote" xmlns="http://www.w3.org/2000/svg"
