const data = {
    "url": "hot-old-broads-nursing-home-mooresville",
    "slug": "Darla and the Hot Old Broads",
    "headline": "'Leave no broad behind': Darla refuses to let people be forgotten",
    "title": "Nursing Home",
    "pub_date": "Nov. 29, 2022",
    "bylines": {
        "Story, design and development by": {
            "name": "Marissa Meador",
            "email": "marnmead@iu.edu",
            "twitter": "marissa_meador",
            "pfp": "https://s3.amazonaws.com/snwceomedia/ids/5b797f8c-c389-4f3a-b42f-6ec84ae09551.sized-1000x1000.jpg",
            "bio": "Marissa has worked at the IDS since 2022 as a reporter and editor."
        },
        "Photos by": [{
...
// bylines
const byline_types = ["By", "Story, design and development by", "Photos by", "Graphics by"]
let bylines_html = '';
let bios_html = '';
