const data = {
  url: "https://specials.idsnews.com/graduate-worker-strike-iu/",
  slug: "Graduate Worker Strike",
  headline: "Everything to know about the IU graduate worker strike",
  title: "Graduate Worker Strike",
  pub_date: "April 13, 2022",
  bylines: {
    "Intro by": {
      name: "Haley Ryan",
      email: "haryan@iu.edu",
