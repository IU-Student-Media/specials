const data = {
    "url": "taylor-swift-hot-takes-life-of-a-showgirl",
    "slug": "Taylor Swift Hot Takes",
    "headline": "OPINION: Hot takes on Taylor Swift's latest album, 'The Life of a Showgirl'",
    "title": "Taylor Swift Hot Takes",
    "pub_date": "Oct. 12, 2025",
    "bylines": {
        "By": {
            "name": "IDS Staff",
...
// bylines
const byline_types = ["By", "Illustrations by", "Design and development by", "Graphics by"]
let bylines_html = '';
let bios_html = '';
...
let allSocials = document.querySelectorAll(".socials");
