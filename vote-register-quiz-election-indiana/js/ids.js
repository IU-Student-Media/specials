...
function checkScroll() { // callback function 
    ...
    if (window.scrollY > startY) {
        ...
        nav.querySelector('svg').style.fill = 'white';
        nav.querySelectorAll('#socials a').forEach((e) => e.style.color = 'white');
        slug.style.display = 'block';
    } else {
        nav.style.backgroundColor = 'transparent';
        nav.querySelector('svg').style.fill = 'black';
        nav.querySelectorAll('#socials a').forEach((e) => e.style.color = 'black');
