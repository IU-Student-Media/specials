const data = {
    "url": "bands-take-main-stage-for-2024-granfalloon-finale",
    // slug will appear in the nav bar
    "slug": "Bands take main stage for 2024 Granfalloon finale",
    // title will appear on the tab in the browser
    "title": "Bands take main stage for 2024 Granfalloon finale",
    "headline": "Bands take main stage for 2024 Granfalloon finale",
    // make sure to update the pub date before finishing the project
    "pub_date": "June 12, 2024",
    "bylines": {
        // fill in photographer info
        "Photos by": [
            {
                "name": "Zuzanna Kukawska",
                "email": "zkukawsk@iu.edu",
            }
        ],
        // fill in digital designer info
        "Design and development by": {
            "name": "Reece Needham",
            "email": "reeneedh@iu.edu",
        }
    }
}
...
if(document.querySelector('.author-bios')) document.querySelector('.author-bios').innerHTML = bios_html;
