const data = {
    "url": "iu-dance-marathon-photo",
    // slug will appear in the nav bar
    "slug": "IU Dance Marathon 2022",
    // headline will go into social buttons
    "headline": "PHOTOS: IU raised over $3 million for Riley Hospital for Children",
    ...
    "bylines": {
        ...
        "Photos by": [
            {
                "name": "Michael Claycamp",
                "email": "cmclayca@iu.edu",
            },
        ],
