const data = {
    "url": "asianfest-returns-buskirk-chumley-theater",
    // slug will appear in the nav bar
    "slug": "Asianfest returns in Buskirk-Chumley Theater",
    // title will appear on the tab in the browser
    "title": "Asianfest returns in Buskirk-Chumley Theater",
    // make sure to update the pub date before finishing the project
    "headline": "Asianfest returns in Buskirk-Chumley Theater",
    "pub_date": "April 5, 2024",
    "bylines": {
