const data = {
    "url": "solar-eclipse-2024-bloomington-indiana-what-is-an-eclipse",
    "slug": "Eclipse 2024",
    "headline": "Eclipse 2024",
    "title": "Eclipse 2024",
    "pub_date": "Mar 24, 2024",
    "bylines": {
        "By" : {
            "name": "Ethan Roberts",
        },
        "Design and development by": {
            ...
            "twitter": "MCloteaux",
            "pfp": "https://s3.amazonaws.com/snwceomedia/ids/ed13c2d4-9cdc-4392-8dff-2e4b3d1330e7.original.jpg",
...
function setAuthorBio(type, author) {
    let twitter_link = `<span><a class="dark" href="https://twitter.com/${author.twitter}" target="_blank">Twitter <i class="fab fa-twitter"></i></a></span>`;
    let email_link = `<span style="padding-right: var(--xs); padding-left: var(--xxs);"><a class="dark"
        ...
        bios_html +=
            `<div class="bio">
                        <div>
                            ...
                            <div>
                            <p>${type} <a class="dark" href="https://idsnews.com/staff/${author.name.split(' ').join('-')}" target="_blank">${author.name}</a></p>
